...
public class CalleeWriteObserver extends BaseRegionObserver {
    ...
    public void postPut(ObserverContext<RegionCoprocessorEnvironment> e, Put put, WALEdit edit, Durability durability)
        ...
        int regions = Integer.parseInt(PropertiesUtil.getProperty("hbase.calllog.regions"));
        ...
        calleePut.add(Bytes.toBytes("f2"), Bytes.toBytes("build_time_ts"), Bytes.toBytes(buildTimeTs));

        HTableInterface table = e.getEnvironment().getTable(TableName.valueOf(targetTableName));
        table.put(calleePut);
        table.close();
